 ...
 */
class SystemBarTintManager @SuppressLint("ResourceType") @TargetApi(19) constructor(activity: AppCompatActivity) {
    companion object {
        /**
        ...
        init {
            /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                sNavBarOverride = try {
                    ...
                    val m: Method = com.door.doorplayer.util.system_related.c.getDeclaredMethod("get", String::class.java)
                    com.door.doorplayer.util.system_related.m.setAccessible(true)
                    com.door.doorplayer.util.system_related.m.invoke(null, "qemu.hw.mainkeys")
                } catch (e: Throwable) {
                    null
                }
            }*/
    ...
    private fun setupStatusBarView(context: Context, decorViewGroup: ViewGroup) {
        ...
        val params = FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, config.statusBarHeight)
     ...
     */
    class SystemBarConfig(activity: AppCompatActivity, translucentStatusBar: Boolean, traslucentNavBar: Boolean) {
